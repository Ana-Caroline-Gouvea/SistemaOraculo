    ...
    public class EventoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Evento != null ? 
                          ...
                          Problem("Entity set 'Contexto.Evento'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("EventoId,EventoFoto,EventoTexto")] Evento evento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventoId,EventoFoto,EventoTexto")] Evento evento)
        {
